...
var imageExists_1 = require("../utils/imageExists");
...
var getImage = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var imageName, width, height, originalPath, newPath, notFound;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                imageName = req.params.imageName;
                width = req.query.width ? parseInt(req.query.width.toString()) : 300;
                height = req.query.width ? parseInt(req.query.width.toString()) : 300;
                originalPath = path_1.default.join(__dirname, "../database/".concat(imageName, ".jpg"));
                newPath = path_1.default.join(__dirname, "../database/thumb/".concat(imageName, "_").concat(width, "x").concat(height, ".jpg"));
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, imageService_1.editImage)(newPath, imageName, width, height)];
            case 2:
                _a.sent();
